...
<body>
    ...
    foreach ($section_order as $sec) {
        if (in_array($sec, ['education', 'research', 'publications'])) {
            ...
            if ($sec == 'about')
                $menu_items[] = ['id' => 'about', 'icon' => 'fa-user', 'label' => 'About'];
            elseif ($sec == 'skills' && $skills)
                $menu_items[] = ['id' => 'skills', 'icon' => 'fa-star', 'label' => 'Skills'];
            elseif ($sec == 'work' && $work)
                $menu_items[] = ['id' => 'work', 'icon' => 'fa-briefcase', 'label' => 'Work'];
            elseif ($sec == 'projects' && $projects)
                $menu_items[] = ['id' => 'projects', 'icon' => 'fa-project-diagram', 'label' => 'Projects'];
            elseif ($sec == 'achievements' && $achievements)
                $menu_items[] = ['id' => 'achievements', 'icon' => 'fa-trophy', 'label' => 'Achievements'];
            elseif ($sec == 'blogs' && $blogs)
                $menu_items[] = ['id' => 'blogs', 'icon' => 'fa-blog', 'label' => 'Blogs'];
            elseif ($sec == 'contact')
                $menu_items[] = ['id' => 'contact', 'icon' => 'fa-envelope', 'label' => 'Contact'];
            elseif ($sec == 'reviews' && $reviews)
                $menu_items[] = ['id' => 'reviews', 'icon' => 'fa-comments', 'label' => 'Reviews'];
        }
    }
    ...
    <nav class="portfolio-nav">
        <div class="portfolio-nav-inner">
            <ul>
                <li><a href="#hero" onclick="scrollToSection('hero')" class="nav-link active"><i
                            class="fas fa-home"></i> Home</a></li>
                <?php foreach ($menu_items as $item): ?>
                    <?php if (is_array($item) && isset($item['type']) && $item['type'] === 'dropdown'): ?>
                        <li class="nav-dropdown">
                            <a href="javascript:void(0)" class="dropdown-trigger"><i
                                    class="fas <?php echo $item['icon']; ?>"></i> <?php echo $item['label']; ?> <i
                                    class="fas fa-chevron-down" style="font-size: 0.7em; margin-left: 4px;"></i></a>
                            <ul class="dropdown-menu">
                                <?php foreach ($item['items'] as $subitem): ?>
                                    <li><a href="#<?php echo $subitem['id']; ?>"
                                            onclick="scrollToSection('<?php echo $subitem['id']; ?>')" class="nav-link"><i
                                                class="fas <?php echo $subitem['icon']; ?>"></i>
                                            <?php echo $subitem['label']; ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </li>
                    <?php elseif (is_array($item)): ?>
                        <li><a href="#<?php echo $item['id']; ?>" onclick="scrollToSection('<?php echo $item['id']; ?>')"
                                class="nav-link"><i class="fas <?php echo $item['icon']; ?>"></i>
    ...
    <?php if ($review_submitted): ?>
        <div id="toastNotification"
            ...
            <div>
                ...
                <p style="margin: 0; color: rgba(255, 255, 255, 0.9); font-size: 0.9rem; line-height: 1.4;">Thank you for
                    your review! It will appear on this portfolio after admin approval.</p>
            </div>
        </div>
        <style>
    ...
    <div class="portfolio-container">
        ...
        <?php foreach ($section_order as $sec):
            switch ($sec):
                case 'about': ?>
                    <!-- About Me Section -->
                                    ...
                                    <div class="card" style="display: flex; flex-direction: column; height: 100%;">
                                        ...
                                        <div style="margin-bottom: 0.75rem; display: flex; flex-wrap: wrap; gap: 0.4rem;">
                                            ...
                                            foreach ($tags as $tag):
                                                ?>
                                                <span
                                                    style="background: rgba(59, 130, 246, 0.1); color: var(--text-muted); font-size: 0.75rem; padding: 0.2rem 0.5rem; border-radius: 4px; border: 1px solid rgba(59, 130, 246, 0.2);">
                                        ...
                                        <p
                                            style="color: var(--text-muted); display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; margin: 0 0 1.25rem 0; flex-grow: 1;">
                                        ...
                                        <div style="display: flex; gap: 0.75rem; margin-top: auto; flex-wrap: wrap;">
                                            ...
                                            <?php if (!empty($p['git_url'])): ?>
                                                <a href="<?php echo htmlspecialchars($p['git_url']); ?>" target="_blank"
                                            ...
                                            <?php if (!empty($p['live_demo_url'])): ?>
                                                <a href="<?php echo htmlspecialchars($p['live_demo_url']); ?>" target="_blank"
                                                    rel="noopener noreferrer"
                                            ...
                                            <?php if (!empty($p['video_url'])): ?>
                                                <a href="<?php echo htmlspecialchars($p['video_url']); ?>" target="_blank"
                                                    rel="noopener noreferrer"
                                ...
                                <?php foreach ($education as $e): ?>
                                    <div class="timeline-item">
                                        ...
                                        <div style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 1rem;">
                                            <i class="fas fa-calendar-alt"></i> <?php echo $e['start_date']; ?> -
                                            <?php echo $e['end_date'] ?: 'Present'; ?>
                                            <?php if (!empty($e['result'])): ?>
                                                <span style="margin-left: 1rem;"><i class="fas fa-award" style="color: var(--accent);"></i>
                                                    Result: <strong><?php echo htmlspecialchars($e['result']); ?></strong></span>
                                            <?php endif; ?>
                                        </div>
                        ...
                        <section class="glass-panel" id="research" style="animation-delay: 0.45s;">
                            ...
                            <div class="card-grid" style="margin-top: 1.5rem;">
                                <?php foreach ($researches as $research): ?>
                                    <div class="card" style="display: flex; flex-direction: column; height: 100%;">
                                        <h3 style="color: #fff; margin-bottom: 0.5rem; word-break: break-word;">
                                            <?php echo htmlspecialchars($research['title']); ?></h3>
                                        <div style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 0.5rem;">
                                            <?php if ($research['publication_date']): ?>
                                                <i class="fas fa-calendar-alt"></i>
                                                <?php echo htmlspecialchars($research['publication_date']); ?>
                                            <?php endif; ?>
                                        </div>
                                        <?php if ($research['tags']): ?>
                                            <div style="margin-bottom: 0.5rem;">
                                                ...
                                                foreach ($tags as $tag):
                                                    ?>
                                                    <span
                                                        style="display: inline-block; background: rgba(59, 130, 246, 0.1); color: var(--accent); padding: 0.2rem 0.5rem; border-radius: 12px; font-size: 0.8rem; margin-right: 0.3rem; margin-bottom: 0.3rem;">
                        ...
                        <section class="glass-panel" id="publications" style="animation-delay: 0.45s;">
                            ...
                            <div class="card-grid" style="margin-top: 1.5rem;">
                                <?php foreach ($publications as $pub): ?>
                                    <div class="card" style="display: flex; flex-direction: column; height: 100%;">
                                        <h3 style="color: #fff; margin-bottom: 0.5rem; word-break: break-word;">
                                            <?php echo htmlspecialchars($pub['title']); ?></h3>
                                        <div style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 0.5rem;">
                                            <?php if ($pub['authors']): ?>
                                ...
                                <div id="blogsCarousel"
                                    ...
                                    <?php foreach ($blogs as $b): ?>
                                        <div class="blog-slide">
                                            <h3
                                                style="color: var(--accent); margin-top: 0; margin-bottom: 0.5rem; word-break: break-word; font-size: 1.25rem;">
                                            ...
                                            <p
                                                style="color: var(--text-muted); font-size: 0.95rem; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; line-height: 1.6; margin-bottom: 1.5rem; flex-grow: 1;">
                                                <?php echo nl2br(htmlspecialchars($b['content'])); ?>
                                            </p>
                                            <div style="margin-top: auto; padding-top: 1rem; text-align: right;">
                                                <button class="btn"
                                                    style="padding: 0.5rem 1.25rem; font-size: 0.85rem; background: rgba(59, 130, 246, 0.15); color: var(--accent); border: 1px solid rgba(59, 130, 246, 0.3); border-radius: 8px; font-weight: 600; cursor: pointer; transition: all 0.3s ease;"
                                                    ...
                                                    onclick="openBlogModal(<?php echo htmlspecialchars(json_encode($b)); ?>)">Read
                                                    More</button>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
    ...
    <div id="projectModal"
        ...
        <div
            ...
            <div id="projectImageContainer"
                style="display: none; margin-bottom: 1.5rem; width: 100%; border-radius: 12px; border: 1px solid rgba(59, 130, 246, 0.3); padding: 0.5rem; background: rgba(59, 130, 246, 0.08);">
            ...
            <div id="projectDescription"
                style="color: var(--text-muted); font-size: 1.05rem; line-height: 1.8; margin-bottom: 1.5rem; white-space: pre-wrap;">
            </div>
    ...
    <div id="blogModal"
        style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.7); z-index: 2000; align-items: center; justify-content: center; padding: 1rem; animation: fadeIn 0.3s ease;">
        <div
            style="background: linear-gradient(135deg, rgba(30, 41, 59, 0.98), rgba(15, 23, 42, 0.98)); border: 1px solid rgba(59, 130, 246, 0.3); border-radius: 20px; padding: 2.5rem; backdrop-filter: blur(15px); max-width: 700px; width: 100%; max-height: 85vh; overflow-y: auto; position: relative; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.5);">
            ...
            <div id="blogModalContent"
                style="color: rgba(241, 245, 249, 0.9); font-size: 1.05rem; line-height: 1.8; margin-bottom: 1rem; white-space: pre-wrap; word-break: break-word;">
            </div>
        </div>
    </div>
